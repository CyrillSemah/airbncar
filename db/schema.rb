...
ActiveRecord::Schema[8.0].define(version: 2024_12_10_211416) do
  ...
  create_table "cars", force: :cascade do |t|
    ...
    t.float "longitude"
    t.string "color"
    t.index ["available"], name: "index_cars_on_available"
    t.index ["brand"], name: "index_cars_on_brand"
    t.index ["car_type"], name: "index_cars_on_car_type"
    t.index ["latitude", "longitude"], name: "index_cars_on_latitude_and_longitude"
    t.index ["location"], name: "index_cars_on_location"
    t.index ["model"], name: "index_cars_on_model"
    t.index ["owner_id"], name: "index_cars_on_owner_id"
    t.index ["price_per_day"], name: "index_cars_on_price_per_day"
